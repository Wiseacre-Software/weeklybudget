...
class BankAccount(models.Model):
    ...
    account_limit = models.DecimalField(max_digits=18, decimal_places=4, null=True)
    active = models.BooleanField(default=True)
    history = HistoricalRecords()
...
class Payment(models.Model):
    ...
    offset = models.SmallIntegerField(default=0)  # positive or negative number of offset_type away from parent
